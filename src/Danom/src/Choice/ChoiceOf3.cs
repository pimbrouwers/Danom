namespace Danom {
    ...
    /// <summary>
    /// Represents a choice between three types, T1, T2 and T3.
    /// </summary>
    /// <typeparam name="T1"></typeparam>
    /// <typeparam name="T2"></typeparam>
    /// <typeparam name="T3"></typeparam>
    public readonly struct Choice<T1, T2, T3> : IEquatable<Choice<T1, T2, T3>> {
        private readonly byte _state; // 1 = T1, 2 = T2, 3 = T3
        ...
        /// <summary>
        /// Returns true if <see cref="Choice{T1, T2, T3}"/> is T1, false otherwise.
        /// </summary>
        public bool IsT1 => _state == 1;

        /// <summary>
        /// Returns true if <see cref="Choice{T1, T2, T3}"/> is T2, false otherwise.
        /// </summary>
        public bool IsT2 => _state == 2;

        /// <summary>
        /// Returns true if <see cref="Choice{T1, T2, T3}"/> is T3, false otherwise.
        /// </summary>
        public bool IsT3 => _state == 3;

        /// <summary>
        /// If <see cref="Choice{T1, T2, T3}"/> is T1 evaluate the t1 delegate,
        ...
        /// <param name="t3"></param>
        /// <returns></returns>
        public U Match<U>(Func<T1, U> t1, Func<T2, U> t2, Func<T3, U> t3) => _state switch {
        ...
        /// <summary>
        /// Creates a new <see cref="Choice{T1, T2, T3}"/> from the specified T1 value.
        /// </summary>
        /// <param name="t1"></param>
        /// <returns></returns>
        public static Choice<T1, T2, T3> FromT1(T1 t1) =>
            new Choice<T1, T2, T3>(t1);

        /// <summary>
        /// Creates a new <see cref="Choice{T1, T2, T3}"/> from the specified T2 value.
        /// </summary>
        /// <param name="t2"></param>
        /// <returns></returns>
        public static Choice<T1, T2, T3> FromT2(T2 t2) =>
            new Choice<T1, T2, T3>(t2);

        /// <summary>
        /// Creates a new <see cref="Choice{T1, T2, T3}"/> from the specified T3 value.
        /// </summary>
        /// <param name="t3"></param>
        /// <returns></returns>
        public static Choice<T1, T2, T3> FromT3(T3 t3) =>
            new Choice<T1, T2, T3>(t3);

        /// <summary>
        /// Returns true if the specified <see cref="Choice{T1, T2, T3}"/>s are equal.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if the specified <see cref="Choice{T1, T2, T3}"/>s are not equal.
        /// </summary>
        /// <param name="left"></param>
        /// <param name="right"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns true if the specified object is equal to the current <see cref="Choice{T1, T2, T3}"/>.
        /// </summary>
        /// <param name="obj"></param>
        /// <returns></returns>
        public override bool Equals(object? obj) =>
            obj is Choice<T1, T2, T3> choice && Equals(choice);

        /// <summary>
        /// Returns true if the specified Choice is equal to the current <see cref="Choice{T1, T2, T3}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns the hash code for the <see cref="Choice{T1, T2, T3}"/>.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns a string representation of the <see cref="Choice{T1, T2, T3}"/>.
        /// </summary>
        ...
        /// <param name="t2"></param>
        /// <param name="t3"></param>
        public void Deconstruct(out short state, out T1 t1, out T2 t2, out T3 t3) {
            state = _state;
            t1 = _t1;
            t2 = _t2;
            t3 = _t3;
