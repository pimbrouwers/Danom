namespace Danom
{
    ...
    public static class OptionNullableExtensions
    {
        ...
        public static Option<string> ToOption(this string? x) =>
            !string.IsNullOrWhiteSpace(x) ? Option<string>.Some(x) : Option<string>.None();
        ...
        /// <param name="option"></param>
        /// <returns></returns>
        public static TimeOnly? ToNullable(this Option<TimeOnly> option) =>
            option.Match(x => new TimeOnly?(x), () => null);
#endif
    }
}
